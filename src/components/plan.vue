<template>
  <div class="plan">
    ...
    <div class="cnt">
      <div v-show="cur == 0">
        <h1>我们粗发啦~~！</h1>
        <p>预计31号晚上19：15到机场，出机场后搭地铁到较口场站（民宿在洪崖洞是小什字，在解放碑是较场口），车程40分-1小时，然后去找民宿歇一会~</p>
        <p>八点半-九点半后吃吃喝喝准备跨年。</p>
        <p>跨年首选 <span>洪崖洞 => 八一好吃街</span> 附近，随意走走，哪好玩逛哪。</p>
        <p></p>
        <h1>DAY 1</h1>
        <p>早上吃完早饭出发</p>
        <p><span>解放碑 => 长江索道（20单程/30往返，琪姐强烈要求要去的） => 朝天门码头 => 来福士广场（一路拍拍拍~打卡打卡打卡~~）</span></p>
        <p></p>
        <p></p>
        <h1>行李：</h1>
      ...
      <div v-show="cur == 1">
        <h1>DAY 2</h1>
        <p><span>鹅岭二厂 => 李子坝（穿楼城轨） => 白象居（少年的你取景地） => 磁器口（有卡通人物找你拍照要拒绝，要钱的） => （不确定）两江游（5元怀旧轮渡，虽然不知道在哪）</span></p>
        <p></p>
        <p></p>
        <h1>干饭建议：</h1>
      ...
      <div v-show="cur == 2">
        <h1>DAY 3 （游玩建议）</h1>
        <p><span>马房湾七彩巷 => 弹子石老街 => 交通茶馆 => （不知道了，到时再来吧看见哪去哪）</span></p>
        <p></p>
        <p></p>
        <h1>干饭建议：</h1>
